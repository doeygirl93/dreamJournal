  ...
  try{
    const response = await client.chat.send({
      chatRequest: {
        ...
        messages: [
          { role: 'user', content: `${dreams}\nThis is a collection of dream journal entries. Analyze these entries for recurring SPECIFIC objects/symbols, themes, or situations. This is to help the user identify "dream signs", which signal that someone is in a dream to help with lucid dreaming. Do not give the user a "tutorial" on how to lucid dream. Only classify a symbol/pattern as recurring if it appears in at least 2/3 of the dreams. COMPLETELY REFRAIN from making a reference to such a threshold-- the user doesn't know about this. Symbols/patterns that are recurring in at least 2/3 of dreams but are somewhat ambiguous or "a stretch", appropriate warning should be provided. Remove all astericks, hashtags, and other special characters unless they are used as punctuation.
